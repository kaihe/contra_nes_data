...
The datahouse producer for `doc/0021-design-boss-frame-shards.md`. Frames are
...
def build_frames(*, house_dir: str, task_dir: str, weapon: str = "laser",
                 shard_count: int = 18, level: int = 1, task: str = "boss",
...
def main(argv=None):
    ...
    parser.add_argument("--weapon", default="laser",
                        choices=("spread", "laser", "regular"))
    parser.add_argument("--shard-count", type=int, default=18,
                        help="token-shard prefix to mirror (18 = D10k Laser)")
