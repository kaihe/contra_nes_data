...
- [0010 Spread/Laser projectile visibility](0010-exp-level1-encoder-baseline.md) — Implemented — no evidence encoder quality explains the weapon win-rate gap
- [0011 Four-code VQ image encoder](0011-design-vq-image-encoder.md) — Proposed — offline discrete frames with one temporal position per frame
