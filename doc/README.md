...
- [0019 Frame-difference one-token experiment](0019-exp-frame-difference-one-token-encoder.md) — Proposed — compare six-channel temporal early fusion with the 0010 baseline
